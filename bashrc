...
# # export CPLUS_INCLUDE_PATH=$PATH5:$PATH6:$PATH7:$PATH8
#
#
...
# alias metashape_online='~/Downloads/metashape-pro/metashape.sh --node --host 192.168.51.205 --root /run/user/1000/gvfs/smb-share:server=192.168.51.202,share=server_network_computing'
#
#
# # add to path for protobuf
# export PATH=/home/ivm/.local:$PATH
